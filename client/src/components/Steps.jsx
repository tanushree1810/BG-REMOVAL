        ...
        <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Select and upload your image effortlessly.</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Click 'Remove Background' for instant results.</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Download your clean image with a simple click.</p>
                </div>
            </div>
